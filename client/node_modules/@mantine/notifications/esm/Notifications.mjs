...
const Notifications = factory((_props, ref) => {
  ...
  const items = data.notifications.map(({ style: notificationStyle, ...notification }) => /* @__PURE__ */ jsx(
    Transition,
    {
      timeout: duration,
  ...
  return /* @__PURE__ */ jsx(OptionalPortal, { withinPortal, ...portalProps, children: /* @__PURE__ */ jsx(Box, { ...getStyles("root"), ref, ...others, children: /* @__PURE__ */ jsx(TransitionGroup, { children: items }) }) });
});
