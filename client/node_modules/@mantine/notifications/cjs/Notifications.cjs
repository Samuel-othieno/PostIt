...
const Notifications = core.factory((_props, ref) => {
  ...
  const items = data.notifications.map(({ style: notificationStyle, ...notification }) => /* @__PURE__ */ jsxRuntime.jsx(
    Transition,
    {
      timeout: duration,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(core.OptionalPortal, { withinPortal, ...portalProps, children: /* @__PURE__ */ jsxRuntime.jsx(core.Box, { ...getStyles("root"), ref, ...others, children: /* @__PURE__ */ jsxRuntime.jsx(reactTransitionGroup.TransitionGroup, { children: items }) }) });
});
