      ...
      <div className="flex flex-col items-center">
        <div className="w-[60%]">
          ...
          <div className=" mt-[10%] w-[70vw] max-[653px]:gap-4 grid grid-cols-1 place-items-center sm:grid-cols-2 gap-10">
            <Card
              title="Simple"
              description="With intuitive interface,ChatBox is so simple you already know how to use it"
            ></Card>
            <Card
              title="Synced"
              description="ChatBox lets you acess your chats. Keeping it secured in databases"
            ></Card>
            <Card
              title="Private"
              description="ChatBox messages are heavily encrypted and can self-destruct"
            ></Card>
            <Card
              title="Secure"
              description="ChatBox keeps your messages safe from hacker attacks"
            ></Card>
          </div>
        </div>
      </div>
